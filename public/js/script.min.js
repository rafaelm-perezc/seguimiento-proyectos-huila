document.addEventListener('DOMContentLoaded', () => {
    ...
    btnAddLocation.addEventListener('click', () => {
        ...
        const isGeneral = modoAvanceGeneral.checked;
        if (isGeneral && txtAvanceGeneral.value === '') {
            return Swal.fire('Falta Avance', 'Ingresa el % de avance general', 'warning');
        }
        if (!isGeneral && txtAvanceLocal.value === '') {
            return Swal.fire('Falta Avance', 'Ingresa el % de avance por sede', 'warning');
        }
        ...
        const avanceValue = isGeneral ? txtAvanceGeneral.value : txtAvanceLocal.value;
        const obsValue = isGeneral ? txtObservacionesGeneral.value : txtObservacionesLocal.value;
        ...
        const locationObj = {
            ...
            avance: avanceValue,
            observaciones: obsValue ? obsValue.toUpperCase() : null
        };
    ...
    function resetForm() {
        ...
        updateFinanceManualVisibility();
        clearLocationFields();
        modoAvanceSede.checked = true;
        txtAvanceGeneral.value = '';
        txtObservacionesGeneral.value = '';
        toggleModoAvance();
