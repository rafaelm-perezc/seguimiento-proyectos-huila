document.addEventListener('DOMContentLoaded', () => {
    ...
    chkEditResp.addEventListener('change', () => {
        if (chkEditResp.checked) {
            ...
            txtResponsable.classList.remove('input-readonly');
            txtResponsable.style.backgroundColor = '#ffffff';
            txtResponsable.focus();
        } else {
            txtResponsable.disabled = true;
            txtResponsable.readOnly = true;
            txtResponsable.classList.add('input-readonly');
            txtResponsable.style.backgroundColor = '#e9ecef';
    ...
    if (btnNewProject) {
        btnNewProject.onclick = () => {
            ...
            chkEditResp.checked = true;
            txtResponsable.disabled = false;
            txtResponsable.readOnly = false;
            txtResponsable.classList.remove('input-readonly');
            txtResponsable.style.backgroundColor = '#ffffff';
            txtResponsable.style.color = '#000000';
    ...
    function loadIndicadores() {
        fetch('/api/indicadores')
            .then(r => r.json())
            .then(d => populateSelect(selectIndicador, d));
    }
